export const dialogueData = {
    ksb001: {
      title: 'IMBIT Studium - Aller was Feines!',
      text: 'Ei gude! IMBIT an de DHBW Mannheim - dess iss was Beschdes! International Management for Business and IT, alles uff Englisch. Do lernschd BWL unn IT zsamme - perfekt ferr die globale Wirtschaft. Unn dess Beschde: Du kannschd bei KSB dein duales Studium mache!',
      answers: [],
    },
    ksb002: {
    ...
    ksb003: {
      title: 'Duales Studium - Theorie unn Praxis!',
      text: 'Aller, dess duale Studium bei KSB iss de Hammer! Du studierst an de DHBW unn arbeitschd gleichzeitig im Unternehme. Pumpe, Armaturen, Service - alles was mit Fluidtechnik zu due hott. Perfekte Kombination aus Theorie unn Praxis, gell!',
      answers: [],
    },
    ksb004: {
    ...
    ksb007: {
      title: 'Quiz zu KSB - Weißt du Bescheid?',
    ...
    ksb009: {
      title: 'Quiz zur Ausbildung - Weißt dus?',
      text: 'Wie lange dauert eine typische Ausbildung bei KSB?',
      answers: ['2 Jahre', '3 Jahre', '4 Jahre'],
      correctAnswer: 2,
      correctText: 'Genau! Die meischde Ausbildunge dauern 3 Jahre - perfekt um alles zu lerne!',
      wrongText: 'Leider falsch - meischdens dauert e Ausbildung 3 Jahre bei KSB.',
      nextQuestion: 'ksb010'
    },
    ksb010: {
    ...
    ksb012: {
      title: 'Quiz zum IMBIT - Was bedeutets?',
      ...
      correctAnswer: 1,
      correctText: 'Richtig! IMBIT steht ferr International Management for Business and IT - perfekt ferr die globale Wirtschaft!',
      wrongText: 'Leider falsch - es steht ferr International Management for Business and IT.',
      nextQuestion: 'ksb013'
    },
    ksb013: {
    ...
    ksb014: {
      title: 'KSB Info - Enn Weltunternehme aus de Pfalz!',
      text: 'Stell der vor: Vunn Frankenthal aus in die ganze Welt! KSB iss enn echtes Erfolgsunternehme - seit 1871 immer am Puls der Zeit. Pumpe unn Armaturen "Made in Pfalz" sinn weltweit gefragt!',
      answers: [],
    },
    ksb015: {
    ...
    ksb016: {
      title: 'Duales Studium - Aller, dess iss perfekt!',
      text: 'Studiere unn gleichzeitig Berufserfahrung sammle? Bei KSB gehts! DHBW Mannheim unn KSB - e unschlagbares Team. Theorie unn Praxis perfekt kombiniert!',
      answers: [],
    },
    ksb017: {
      title: 'Quiz zu KSB Standorten - Wu iss KSB?',
      text: 'Wu hott KSB seinen Hauptsitz?',
    ...
    ksb019: {
      title: 'IMBIT Studium - International durchstarte!',
      text: 'Mit IMBIT an de DHBW Mannheim machschd du alles richtig! International Management for Business and IT - dess iss die Zukunft. Unn bei KSB kannschd du gleich praktische Erfahrunge sammle!',
      answers: [],
    },
    ksb020: {
      title: 'Duales Studium - Beschde Karrierechance!',
      text: 'Aller, dess duale Studium bei KSB iss dei Sprungbrett! Studium an de DHBW, Praxis bei KSB - so wirschd du zum Experte ferr Pumpe unn Armaturen. Die Welt braucht Fluidtechnik-Spezialisten!',
      answers: [],
    },
    ksb021: {
    ...
    ksb026: {
      title: 'Quiz zu KSB heute - Wie gehts weiter?',
      text: 'Was iss KSBs Fokus ferr die Zukunft?',
      answers: ['Digitalisierung und Nachhaltigkeit', 'Nur noch Pumpen', 'Expansion nach Mars'],
      correctAnswer: 1,
      correctText: 'Genau! Digitalisierung unn Nachhaltigkeit - KSB denkt an die Zukunft!',
      wrongText: 'Nit ganz - KSB setzt uff Digitalisierung unn Nachhaltigkeit ferr die Zukunft!',
      finalMessage: 'Aller, du hoscht alles iwwer KSB gelernt! Vielleicht siehmer uns ja bald bei KSB - als Azubi odder Student!'
    },
  };